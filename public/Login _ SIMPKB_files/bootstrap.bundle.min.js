...
!(function (t, e) {
  ...
  class R extends H {
    ...
    close() {
      if (
        P.trigger(this._element, "close.bs.alert")
          .defaultPrevented
      )
        return;
  ...
  class Z extends H {
    ...
    _addTouchEventListeners() {
      ...
      U.find(
        ...
        P.on(t, "dragstart.bs.carousel", (t) =>
          t.preventDefault()
        );
      }),
        this._pointerEvent
  ...
  class Te extends H {
    ...
    show() {
      ...
      if (
        ...
        return;
      const e = Te.getParentFromElement(
        this._element
      );
      this._inNavbar
        ? F.setDataAttribute(
  ...
  class Oe {
    ...
    _applyManipulationCallback(t, e) {
      s(t)
        ? e(t)
        : U.find(t, this._element).forEach(e);
    }
    isOverflowing() {
  ...
  class ni extends H {
    ...
    _activate(t, e, i) {
      const n = (
        ...
        s =
          i && n && n.classList.contains("fade"),
        o = () =>
          this._transitionComplete(t, n, i);
      n && s
    ...
    _transitionComplete(t, e, i) {
      ...
      if (
        ...
        e &&
          U.find(".dropdown-toggle", e).forEach(
  ...
  P.on(
    ...
    function (t) {
      ["A", "AREA"].includes(this.tagName) &&
        t.preventDefault(),
        l(this) ||
          ni.getOrCreateInstance(this).show();
    }
  ),
    m(ni);
  const si = {
