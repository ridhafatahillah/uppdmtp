...
!(function (e, t) {
  ...
  function (g, e) {
    ...
    var p = (function (n) {
      ...
      function se(t, e, n, r) {
        ...
        if (!r && (C(e), (e = e || T), E)) {
          ...
          if (
            ...
            try {
              return (
                O.apply(n, f.querySelectorAll(c)),
                n
              );
            } catch (e) {
              k(t, !0);
      ...
      (se.attr = function (e, t) {
        ...
        var n = x.attrHandle[t.toLowerCase()],
          r =
            n &&
            L.call(x.attrHandle, t.toLowerCase())
              ? n(e, t, !E)
              : void 0;
        return void 0 !== r
          ? r
    ...
    (le = w
      ...
      (ce =
        w.createElement("input")).setAttribute(
        "type",
        "radio"
      ),
      ...
      (m.noCloneChecked = !!le.cloneNode(!0)
    ...
    E.extend({
      ...
      ((Ve = w.createElement("input")).value =
        "t"),
      (Ve.type = "radio"),
    ...
    E.extend(E.event, {
      ...
      (E.parseXML = function (e) {
        ...
        if (!e || "string" != typeof e)
          return null;
        try {
          t = new g.DOMParser().parseFromString(
            e,
            "text/xml"
          );
        } catch (e) {
